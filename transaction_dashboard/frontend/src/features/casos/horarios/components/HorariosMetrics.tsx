// frontend/src/features/casos/horarios/components/HorariosMetrics.tsx
// Componente de métricas para patrones horarios

import React from 'react'
import { Card } from '../../../../components/ui/Card'
import type { HorariosAnalysis } from '../types'

interface HorariosMetricsProps {
  data: HorariosAnalysis
}

export const HorariosMetrics: React.FC<HorariosMetricsProps> = ({ data }) => {
  return (
